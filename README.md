...
# 📖 Online Babysitters <a name="about-project"></a>

**Online Babysitters** is a fully functional website that shows the list of babysitters and services and empower readers to interact with admin through provided contacts. It also has an admin panel to maintain whole website.
...
```sh
  git clone https://github.com/MAleemH/Online-Babysitters.git
```
...
- Create a database with exact name of .db file included in db folder
- Import .db file provided in db folder into newly created database
...
- Type 'localhost/Online-Babysitters' in URL and press enter
